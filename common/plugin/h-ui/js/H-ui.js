...
var JPlaceHolder = {
    ...
    fix : function(){
        jQuery(':input[placeholder]').each(function(index, element) {
            ...
            var holder = $('<span></span>').text(txt).css({position:'absolute', left:pos.left, height:h, lienHeight:h,paddingLeft:paddingleft,color:'#aaa',"line-height":h+"px"}).appendTo(self.parent());
